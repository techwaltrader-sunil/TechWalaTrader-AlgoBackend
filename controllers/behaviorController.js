...
//     // Yahan hum check kar rahe hain ki agar "Dynamic Call Ratio Spread" naam ka rule 
//     // pehle se hai to use update karo, warna naya create kar do (upsert: true)
//     const savedRule = await BehaviorRule.findOneAndUpdate(
//       { strategyName: ruleData.strategyName || "Dynamic Call Ratio Spread" }, 
//       { $set: ruleData },
