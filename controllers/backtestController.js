...
//         // =========================================================
//         let exitConds = {};
//         if (Array.isArray(strategy.exitConditions) && strategy.exitConditions.length > 0) {
//             exitConds = strategy.exitConditions[0];
//         } else if (strategy.exitConditions && !Array.isArray(strategy.exitConditions)) {
//             exitConds = strategy.exitConditions;
//         } else if (Array.isArray(strategy.data?.exitConditions) && strategy.data?.exitConditions.length > 0) {
//             exitConds = strategy.data.exitConditions[0];
//         }

//         const rawExitLongRules = exitConds.longRules || strategy.exitLongRules || [];
//         const rawExitShortRules = exitConds.shortRules || strategy.exitShortRules || [];
