...
//             if (openTrades.length === 0 && isMarketOpen && !isTradingHaltedForDay) {
...
// // =========================================================
// // 🗓️ THE CNC FIX: Calculate Trading Days & Holidays
// // =========================================================
// // const NSE_HOLIDAYS = [
// //     "2024-01-22", "2024-01-26", "2024-03-08", "2024-03-25", "2024-03-29", "2024-04-11", "2024-04-17", "2024-05-01", "2024-06-17", "2024-07-17", "2024-08-15", "2024-10-02", "2024-11-01", "2024-11-15", "2024-12-25",
// //     "2025-02-26", "2025-03-14", "2025-03-31", "2025-04-10", "2025-04-14", "2025-04-18", "2025-05-01", "2025-08-15", "2025-08-27", "2025-10-02", "2025-10-21", "2025-11-05", "2025-12-25",
// //     "2026-01-26", "2026-03-03", "2026-03-20", "2026-04-03", "2026-04-14", "2026-05-01", "2026-08-15", "2026-10-02", "2026-11-08", "2026-12-25"
// // ];
...
// //     return NSE_HOLIDAYS.includes(`${y}-${m}-${d}`);
// // };
...
//             let isCncEntryDay = true;
//             if (orderType === "CNC") {
//                 isCncEntryDay = (currentDTE === cncEntryDays);
//             }
            ...
            if (openTrades.length > 0) {
                ...
                openTrades.forEach(trade => {
                    ...
                    if (isOptionsTrade && trade.premiumChart && trade.premiumChart.start_Time) {
                        ...
                        if (exactMatchIndex !== -1) {
                            // 🟢 TRUTH: Use Real API Data Only! No Fake Math!
                            ...
                            // 🟢 REALITY CHECK: Agar 1-min data missing hai, toh purana real price hi carry-forward karo.
                            currentClose = trade.lastKnownPremium || trade.entryPrice;
                            currentHigh = currentLow = currentOpen = currentClose;
                        }
                    } else if (!isOptionsTrade) {
