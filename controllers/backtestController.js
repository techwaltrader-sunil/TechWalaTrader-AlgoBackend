...
//                         let isDataFrozen = false; // 🔥 NAYA WEAPON: Data Freeze Detector
...
//                                 if (optTime <= istDate) {
//                                     nearestIdx = k;
//                                     // Agar API ka pichla price 5 minute se jyada purana hai, toh samajh lo Data Freeze ho gaya hai!
//                                     const diffMins = (istDate - optTime) / 60000;
//                                     if (diffMins > 5) isDataFrozen = true;
//                                     break;
//                                 }
//                             }
...
//                         if (exactMatchIndex !== -1 && !isDataFrozen) {
...
//                                 if (isFallbackCandle) {
//                                     currentHigh = currentLow = currentOpen = tempClose;
//                                 } else {
...
//                             }
//                         } else {
//                             currentClose = null; // 🚨 SIGNAL TO USE FALLBACK MATH
//                         }
...
//                     // 🔥 THE CLEANED DYNAMIC FALLBACK MATH (Aggressive Worst-Case MTM)
//                     if (isOptionsTrade && currentClose === null && trade.optionConfig) {
...
//                         // 🔥 Worst Case Spot Calculation (M2M VIX Spikes pakadne ke liye)
...
//                         if (dte >= 1) {
//                             estimatedAtmPremium = worstSpot * baseMultiplier * Math.sqrt(dte / 7);
//                         } else {
//                             const minutesLeft = Math.max(0, 930 - timeInMinutes);
//                             estimatedAtmPremium = worstSpot * (baseMultiplier / 2) * Math.sqrt(minutesLeft / 375);
//                         }

//                         const estimatedTimeValue = estimatedAtmPremium / Math.pow(decayFactor, stepDiff);
//                         currentClose = intrinsicValue + estimatedTimeValue;
...
//                                     // Yahan MTM limits ke liye koi 'mathPrice' ya slippage comparison use nahi hoga!
...
//                         if (exactMatchIndex !== -1) {
//                             // 🟢 100% PURE API DATA (Thik SL/TP ki tarah)
//                             currentClose = trade.premiumChart.close[exactMatchIndex];
//                             currentHigh = trade.premiumChart.high[exactMatchIndex];
//                             currentLow = trade.premiumChart.low[exactMatchIndex];
//                             currentOpen = trade.premiumChart.open[exactMatchIndex];
//                             trade.lastKnownPremium = currentClose;
//                         } else {
//                             // 🟢 NO FAKE MATH: Agar API data ek-aadh minute missing hai, toh chupchap pichla real price carry forward karo!
...
//                     // YAHAN SE SARA "DYNAMIC FALLBACK MATH" (Math.pow, decayFactor, etc.) UDA DIYA GAYA HAI!
